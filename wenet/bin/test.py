...
def get_args():
    ...
    parser.add_argument('--test_data', required=False, help='test data file')
    ...
    parser.add_argument('--blank_penalty',
                        ...
                        default=0.0,
                        help='blank penalty')
    parser.add_argument('--result_dir', required=False, help='asr result file')
...
if __name__ == '__main__':
    args = get_args()
    with open("train_u2++_conformer.yaml", 'r') as fin:
